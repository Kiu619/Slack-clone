    ...
    <div className='min-h-screen p-5 grid text-center place-content-center bg-white'>
      <div className='max-w-[450px]'>
        <div className='flex justify-center items-center gap-3 mb-4'>
          <Image src='https://a.slack-edge.com/bv1-13/slack_logo-ebd02d1.svg' alt='Slack' width={120} height={120} />
        </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <fieldset disabled={isAuthenticating}>
                ...
                <Button
                  variant='secondary'
                  className='bg-[var(--primary-slack)] hover:bg-[var(--primary-slack)]/90 w-full my-5 text-white'
                  type='submit'
                >
